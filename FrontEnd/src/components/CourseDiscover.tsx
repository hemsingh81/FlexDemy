...
import { CourseReviewModal, getStoredReviewsForCourse } from './CourseReviewModal';
        ...
        {filteredCourses.length === 0 ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredCourses.map((course) => {
              const reviews = getStoredReviewsForCourse(course.id);
          ...
          <div className="relative w-full max-w-2xl bg-white rounded-3xl shadow-2xl border border-[#E1DED4] p-6 sm:p-8 max-h-[90vh] overflow-y-auto text-[#142030]">
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                <img
                  src={previewCourse.thumbnailUrl || previewCourse.thumbnail}
