...
// be directly link-shared (unlike thumbnails), a deliberate, scoped omission.
public record CourseFileDto(string Id, string FileName, string ContentType, long SizeBytes, string Status, string? FailureReason);
